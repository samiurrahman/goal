...
const Heading: React.FC<HeadingProps> = ({
  ...
  className = 'mb-6 text-neutral-900 dark:text-neutral-50',
  isCenter = false,
  ...args
}) => {
  return (
    <div className={`nc-Section-Heading relative ${className}`}>
      <div className={isCenter ? 'text-center w-full max-w-2xl mx-auto mb-4' : 'max-w-2xl'}>
        ...
        {desc && (
          <span className="block mt-2 md:mt-3 font-normal text-base sm:text-md text-neutral-500 dark:text-neutral-400">
            {desc}
          </span>
        )}
      </div>
