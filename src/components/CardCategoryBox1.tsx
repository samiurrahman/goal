...
const CardCategoryBox1: FC<CardCategoryBox1Props> = ({ className = '', taxonomy }) => {
  ...
  return (
    ...
    >
      <Badge className="absolute right-2 top-2" color="gray" name={convertNumbThousand(count)} />

      <div className="relative flex-shrink-0 w-24 h-24 rounded-full overflow-hidden">
        <Image src={thumbnail || ''} fill alt="" sizes="(max-width: 400px) 100vw, 400px" />
      </div>
